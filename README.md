...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="/storage/emulated/0/Pictures/Photoshop Express/PSX_20250404_140528.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>Sridhar M</h1>
            <p>Am Student</p>
        </div>
    </header>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="/storage/emulated/0/Download/Sridhar M resume.pdf" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
